  ...
  if (showJoinPrompt) {
    return (
      <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
        <div className="bg-gray-800 border border-gray-700 p-6 rounded-lg shadow-lg max-w-sm w-full mx-4">
          <h2 className="text-xl font-bold mb-4 text-gray-100">Join Room?</h2>
          <p className="mb-6 text-gray-300">Would you like to join this music room?</p>
          <div className="flex gap-4 justify-end">
            <Button variant="outline" onClick={() => navigate("/")} className="border-gray-600 text-gray-300 hover:bg-gray-700 hover:text-gray-100">
              No, thanks
            </Button>
            <Button onClick={handleJoinRoom} className="bg-blue-600 hover:bg-blue-700 text-white">Yes, join room</Button>
          </div>
        </div>
      </div>
    );
    ...
    <ErrorBoundary FallbackComponent={ErrorFallback}>
      <div className="min-h-screen bg-gray-900 text-gray-100 pt-16">
        <div className="container mx-auto px-6">
          {/* Simple Room Title */}
          <div className="py-4">
            <h1 className="text-2xl font-semibold text-gray-100">Music Room</h1>
          </div>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-8 space-y-6">
              ...
              {/* Queue Section */}
              <div className="bg-gray-800 rounded-lg shadow-md p-4 border border-gray-700">
                <h2 className="text-xl font-semibold mb-4 text-gray-100">Queue</h2>
                <Queue />
              </div>

              {/* Song Search Component */}
              <div className="bg-gray-800 rounded-lg shadow-md p-4 border border-gray-700">
                <h2 className="text-xl font-semibold mb-4 text-gray-100">Add Songs</h2>
